...
import { useUpdateStableField, useGenerateStableStalls } from '../../hooks/use-stable-chart-mutations';
import { SM_LABEL, SM_ROW_INPUT, SM_GREEN_BTN } from '../show-manager/tokens';
import type { StableChartStable } from '../../data/stable-chart-queries';
