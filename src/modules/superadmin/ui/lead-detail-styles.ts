...
export const LABEL =
  'mb-[7px] block text-[10.5px] font-bold uppercase tracking-[0.12em] text-fa-muted-2';
export const SECTION = 'rounded-[14px] border border-[#E2E8E4] bg-white px-7 pb-7 pt-[26px]';
export const H2 =
  'font-[family-name:var(--font-nr)] text-[21px] font-medium tracking-[-.012em] text-hunter-deep';
export const SAVE =
